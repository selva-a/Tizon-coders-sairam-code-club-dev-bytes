...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item ">
          <a class="nav-link" href="project_display.html"><i class="fas fa-file"> Project </i> </a>
        </li>
        <li class="nav-item ">
            <a class="nav-link" href="courses.html"><i class="far fa-file"> Courses </i> </a>
          </li>
        <li>
      ...
      <?php } ?>
          ...
          <?php if(isset($_SESSION['admin'])) { ?>
            <a class="nav-link" href="event.html"><i class="fas fa-lock"> Events </i> </a>
      <?php } ?>
          <?php if(isset($_SESSION['admin'])) { ?>
            <a class="nav-link" href="logout admin.php"><i class="fas fa-lock"> Logout </i> </a>
      <?php } ?>
          </li>
      </ul>
      ...
      <span class="navbar-text">
        <ul class="navbar-nav navbar-right">
          ...
          <li id="mem-wel"> <?php if(isset($_SESSION['username'])) { ?> 
      ...
      <?php } ?>
          ...
          <li id="admin-wel"> <?php if(isset($_SESSION['admin'])) { ?> 
  ...
  <div class="parallax-window" data-parallax="scroll" data-image-src= "images/laptop-2557586.jpg">
    <h1>
    <font style="arial" font-weight="bolder"> <b>Hours  To  Go !!!</b> </font>
    </h1>
    <a href="form.html" class="btn btn-primary button">
  ...
  <div class="container content">
      ...
      <div class="col-lg-7">
        <h1>
          <p class="event-title"> Sairam Career Camp November 2021</p>
          <p class="event-sub-title">Starts on</p>
          <p class="event-time">12:00PM, 02 NOV 2021</p>
        </h1>
  ...
  <div class="container content">
    <div class="row">
      ...
      <div class="col-lg-7">
        ...
        <p class="event-title"> Sairam Career Camp November 2021</p>
          <p class="event-sub-title">Starts on</p>
          <p class="event-time">12:00PM, 03 NOV 2021</p>
        </h1>
        <a href="form.html"><button class="register-form-btn">Register</button></a>
  ...
  <div class="container content">
    ...
    <div class="col-lg-7">
      ...
      <p class="event-title"> Sairam Career Camp November 2021</p>
          <p class="event-sub-title">Starts on</p>
          <p class="event-time">12:00PM, 04 NOV 2021</p>
      </h1>
      <a href="form.html"><button class="register-form-btn">Register</button></a>
    </div>
    <div class="col-lg-5">
...
<div class="container content">
  <div class="row">
    ...
    <div class="col-lg-7">
      ...
      <p class="event-title"> Sairam Career Camp November 2021</p>
          <p class="event-sub-title">Starts on</p>
          <p class="event-time">12:00PM, 05 NOV 2021</p>
      </h1>
      <a href="form.html"><button class="register-form-btn">Register</button></a>
...
<!--comment 4 ends-->
<div class="classess">
<center><a href="upcoming events.html" class="btn btn-primary button">
